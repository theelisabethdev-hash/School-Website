...
export const pages: PageMeta[] = [
  ...
  { slug: "/form-submission", source: "form_submission.php", title: "Registration Form Submission", description: "Upload your filled registration form PDF and payment receipt screenshot.", h1: "Registration Form Submission", legacy: ["/form_submission.php"], changefreq: "monthly", priority: 0.7 },
