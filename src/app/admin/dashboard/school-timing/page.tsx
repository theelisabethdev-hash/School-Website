...
export default function SchoolTimingAdminPage() {
  ...
  const fieldConfig: {
    ...
    {
      key: "teacherMeeting",
      label: "Meeting Teachers Policy",
      placeholder: "Parents can meet the teachers by …",
      multiline: true,
      rows: 2,
      icon: "fa-users",
      color: "#16a085",
    ...
    {
      key: "principalMeeting",
      label: "Meeting Principal Policy",
      placeholder: "Parents can meet the Principal by …",
      multiline: true,
      rows: 2,
