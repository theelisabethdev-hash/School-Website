...
import { FacilitiesItem } from "@/lib/api";

type Props = {
  items: FacilitiesItem[];
};

export default function FacilitiesPageClient({ items }: Props) {
  return (
...
function FacilityRow({ item, isEven }: { item: FacilitiesItem; isEven: boolean }) {
